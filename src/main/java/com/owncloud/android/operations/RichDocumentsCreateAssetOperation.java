...
public class RichDocumentsCreateAssetOperation extends RemoteOperation {
    ...
    private static final String STREAM_MEDIA_URL = "/apps/richdocuments/assets";
    ...
    protected RemoteOperationResult run(OwnCloudClient client) {
        ...
        try {
            postMethod = new PostMethod(client.getBaseUri() + STREAM_MEDIA_URL);
            ...
            Log_OC.e(TAG, "Get rich document url for file with path " + path + " failed: " + result.getLogMessage(),
                    result.getException());
        } finally {
            if (postMethod != null) {
